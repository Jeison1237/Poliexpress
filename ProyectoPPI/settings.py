"""
Django settings for ProyectoPPI project.
...
SECRET_KEY = 'django-insecure-x*w=ujy-wv88i%ehm#$z2=wg79-o@wkkwa@a!zy+0)3pal!l$e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Asegurar que busque en 'templates'
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'pedidos.context_processors.pedido_activo',
            ],
        },
    },
]
WSGI_APPLICATION = 'ProyectoPPI.wsgi.application'
